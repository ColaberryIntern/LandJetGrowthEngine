...
export default function CampaignsPage() {
  ...
  return (
    <div>
      ...
      {step3.status === 'done' && campaignId && (
        <div className="mt-6 rounded-lg border border-emerald-200 bg-emerald-50 p-4">
          <p className="text-sm font-medium text-emerald-800">Campaign is live. Drafts are ready for review.</p>
          <div className="mt-2 flex gap-4">
            <a href={`/campaigns/${campaignId}`} className="text-sm font-medium text-emerald-700 underline underline-offset-2 hover:text-emerald-900">
              View Campaign →
            </a>
            <a href="/drafts" className="text-sm font-medium text-emerald-700 underline underline-offset-2 hover:text-emerald-900">
              Review Drafts →
            </a>
          </div>
        </div>
